...
public class Principal {
    ...
    // Muestra la informacion de un rectangulo
    public static void mostrarRectangulo(String nombre, Rectangulo r) {
        System.out.println("Rectangulo " + nombre + " = " + r.toString());
    }

    // Retorna el rectangulo que representa el area de sobreposicion
    public static Rectangulo rectanguloSobre(Rectangulo r1, Rectangulo r2) {
        double minX1 = r1.getEsquina1().getX();
        double maxX1 = r1.getEsquina2().getX();
        double minY1 = r1.getEsquina1().getY();
        double maxY1 = r1.getEsquina2().getY();

        double minX2 = r2.getEsquina1().getX();
        double maxX2 = r2.getEsquina2().getX();
        double minY2 = r2.getEsquina1().getY();
        double maxY2 = r2.getEsquina2().getY();

        // Al igual que en sobreposicion, calculamos el rectangulo de interseccion
        // maximo del minimo y minimo del maximo para cada eje
    ...
    public static void main(String[] args) {
        ...
        // Determinar caso y mostrar resultado
